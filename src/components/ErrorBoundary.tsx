      ...
      return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50 p-6 text-center">
          <div className="max-w-md w-full space-y-6">
            ...
            <h1 className="text-2xl font-bold text-gray-900">عذراً، حدث خطأ ما</h1>
            <p className="text-gray-600">{errorMessage}</p>
            <button
              onClick={() => window.location.reload()}
              className="w-full py-3 bg-gold text-black font-bold rounded-xl hover:bg-gold-dark transition-colors"
            >
              تحديث الصفحة
            </button>
          </div>
